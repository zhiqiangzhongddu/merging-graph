...
def parse_args():
    ...
    parser.add_argument('--dataset_setting', default='', type=str, help='which set of datasets to use')
    parser.add_argument(
        '--data_root',
        default=os.environ.get('ANYGRAPH_NODE_DATA_ROOT', './data/node'),
        type=str,
        help='root directory that contains per-dataset folders',
    )
    ...
    parser.add_argument('--result_csv', default=None, type=str, help='optional csv path to save per-dataset evaluation results')
