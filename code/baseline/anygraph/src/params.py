...
def parse_args():
    ...
    parser.add_argument('--eval_protocol', default='agae', type=str, help='[ranking, agae]')
    ...
    parser.add_argument('--edge_eval_payload_name', default='agae_edge_eval_payload.pt', type=str, help='edge eval payload filename in dataset dir')
    parser.add_argument('--edge_eval_threshold_mode', default='val_best_acc', type=str, help='[val_best_acc, zero]')
    parser.add_argument('--edge_eval_repeat_times', default=5, type=int, help='repeat times for edge eval')
    ...
    parser.add_argument(
        '--data_root',
        default=os.environ.get('ANYGRAPH_DATA_ROOT', './zero-shot datasets'),
        type=str,
