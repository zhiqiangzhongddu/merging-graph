...
def set_cfg(cfg: CN) -> CN:
    ...
    cfg.context.model = "gpt-5.2" # language model to use for context generation: gpt-4o-mini, gpt-5.2
    cfg.context.temperature = 0.2 # sampling temperature
    cfg.context.run_all = False  # whether to run context generation to all available datasets/models
    cfg.context.skip_induced_generation = True  # skip induced subgraph building for faster context generation
